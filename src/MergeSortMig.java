...
public class MergeSortMig {
    ...
    public MergeSortMig(ArrayList<Job> inputArray){
    ...
    public void merger(int startIndex,int midIndex,int endIndex){
        ...
        while(leftIndex<=midIndex && rightIndex<=endIndex){
            if(inputArray.get(leftIndex).getMigrationTime() <=  inputArray.get(rightIndex).getMigrationTime()){
